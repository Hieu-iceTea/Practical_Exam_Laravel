# - - - - - - - - - - - - - - - - - - - - Create DataBase - - - - - - - - - - - - - - - - - - - -  #
# Create DataBase
DROP DATABASE IF EXISTS `Practical_Exam_Laravel`;
CREATE DATABASE IF NOT EXISTS `Practical_Exam_Laravel` CHARACTER SET utf8 COLLATE utf8_unicode_ci;

USE `Practical_Exam_Laravel`;
#SET time_zone = '+7:00';
# - - - - - - - - - - - - - - - - - - - - Create Tables - - - - - - - - - - - - - - - - - - - -  #
